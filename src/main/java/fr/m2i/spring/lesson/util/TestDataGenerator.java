package fr.m2i.spring.lesson.util;

import fr.m2i.spring.lesson.model.Account;
import fr.m2i.spring.lesson.model.Address;
import fr.m2i.spring.lesson.model.Credentials;
import fr.m2i.spring.lesson.model.Gender;
import fr.m2i.spring.lesson.model.Role;
import fr.m2i.spring.lesson.model.RoleType;
import fr.m2i.spring.lesson.model.User;
...
public class TestDataGenerator {
   ...
   public static Account getAccount(){
        ...
        fakeAccount.setBalance(Float.valueOf(random.nextInt(200000)));
